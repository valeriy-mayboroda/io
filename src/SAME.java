...
public class Same {
    ...
    public static boolean        permitAddedRemoved = true;//permitAdded_Removed = true - pазрешить ADDED или REMOVED
    public static boolean        mistake = false;//mistake = true - ошибка - операции ADDED - REMOVED невозможно разделить операцией SAME
    ...
    public static void makeAddedRemoved(Type type) {
